...
class NaverSearchApiClientIntegrationTest {
    ...
    public void checkRetryConfiguration() {
        Assertions.assertEquals(3, retryRegistry.retry("naverSearchBlog").getRetryConfig().getMaxAttempts());
    }
    ...
    public void testCircuitBreakerOpenedThrowsScenario() {
        ...
        circuitBreakerRegistry.circuitBreaker("naverSearchBlog").transitionToOpenState();
